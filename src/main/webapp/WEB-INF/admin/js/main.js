...
var treeData = [{"checked":false,"code":"1001","data":[],"name":"拦截所有"},{"checked":false,"code":"1002","data":[],"name":"账户相关操作放行"},{"checked":false,"code":"1003","data":[],"name":"角色相关操作放行"},{"checked":false,"code":"1004","data":[],"name":"权限相关操作放行"},{"checked":false,"code":"1005","data":[],"name":"用户添加"},{"checked":false,"code":"1006","data":[],"name":"用户修改"},{"checked":false,"code":"1007","data":[],"name":"用户查询"},{"checked":false,"code":"1008","data":[],"name":"2"},{"checked":true,"code":"1009","data":[],"name":"学生查询"}];
layui.config({
    base : 'js/'
}).extend({
