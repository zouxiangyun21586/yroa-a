...
<div class="layui-dropdown">
      ...
      <ul class="layui-dropdown-menu">
		  <<li><a lay-event="state"><i class="layui-icon" style="font-size:18px;">&#xe612; </i>{{d.use==0?'禁用权限':'启用权限'}}</a></li>
		  <li><a lay-event="edit"><i class="layui-icon" style="font-size:18px;">&#xe642; </i>编辑</a></li>
          <li><a lay-event="del"><i class="layui-icon" style="font-size:18px;">&#xe640; </i>删除权限</a></li>
      </ul>
  </div>
</script>
<!--<li><a lay-event="edit"><i class="layui-icon" style="font-size:18px;">&#xe642; </i>编辑</a></li>  -->
