		...
		<blockquote class="layui-elem-quote quoteBox">
			<form class="layui-form">
				<div class="demoTable">
					...
					<div class="layui-inline">
						<a class="layui-btn layui-btn-normal addUser_btn">添加课程</a>
					</div>
				</div>
			</form>
		</blockquote>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/js/class/classList.js"></script>
...
<div class="layui-dropdown">
      ...
      <ul class="layui-dropdown-menu">
          ...
          <li><a lay-event="del"><i class="layui-icon" style="font-size:18px;">&#xe640; </i>删除课程</a></li>
      </ul>
  </div>
</script>
</html> 